...
<nav>
  ...
  <div class="nav-links">
    ...
    <button onclick="showPage('dashboard')" id="nav-dashboard" style="color:var(--green);font-weight:600">📋 Mi Menú</button>
...
<div id="page-home" class="page active">
  ...
  <!-- ── SELECTOR DE ROL ── -->
  <div style="background:linear-gradient(135deg,#111 0%,#2a1a0e 60%,#3d2010 100%);padding:56px 24px 48px;text-align:center">
    <div style="display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);border-radius:20px;padding:6px 16px;margin-bottom:20px">
      <span style="font-size:12px;color:#FFD9B8;font-weight:600;letter-spacing:1px;text-transform:uppercase">¿Qué eres tú?</span>
    </div>
    <h1 style="font-family:'Playfair Display',serif;font-size:clamp(28px,5vw,48px);font-weight:900;color:white;margin-bottom:8px;line-height:1.15">Bienvenido a <em style="color:#4CAF50;font-style:normal">Micasero</em></h1>
    <p style="color:rgba(255,255,255,0.6);font-size:15px;margin-bottom:36px">Elige cómo quieres usar la plataforma</p>

    <!-- Las dos tarjetas de rol -->
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;max-width:600px;margin:0 auto">

      <!-- CLIENTE -->
      <button onclick="showPage('map')" style="background:rgba(255,255,255,0.06);border:1.5px solid rgba(255,255,255,0.12);border-radius:20px;padding:28px 20px;cursor:pointer;text-align:center;font-family:'DM Sans',sans-serif;-webkit-appearance:none">
        <div style="font-size:44px;margin-bottom:12px">🍽️</div>
        <div style="font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:white;margin-bottom:8px">Soy Cliente</div>
        <div style="font-size:13px;color:rgba(255,255,255,0.55);line-height:1.5;margin-bottom:16px">Quiero encontrar cocineros y pedir comida casera</div>
        <div style="background:#4CAF50;color:white;border-radius:10px;padding:10px 16px;font-size:13px;font-weight:700">
          Buscar Cocineros →
        </div>
      </button>

      <!-- COCINERO -->
      <button onclick="showPage('membresia')" style="background:rgba(255,255,255,0.06);border:1.5px solid rgba(255,255,255,0.12);border-radius:20px;padding:28px 20px;cursor:pointer;text-align:center;font-family:'DM Sans',sans-serif;-webkit-appearance:none">
        <div style="font-size:44px;margin-bottom:12px">👨‍🍳</div>
        <div style="font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:white;margin-bottom:8px">Soy Cocinero</div>
        <div style="font-size:13px;color:rgba(255,255,255,0.55);line-height:1.5;margin-bottom:16px">Quiero publicar mi menú y conseguir clientes</div>
        <div style="background:#E8622A;color:white;border-radius:10px;padding:10px 16px;font-size:13px;font-weight:700">
          Ver Planes →
        </div>
      </button>
    </div>

    <!-- Mini nota de transparencia -->
    <p style="color:rgba(255,255,255,0.35);font-size:12px;margin-top:24px">
      💡 Clientes pagan directo al cocinero · Micasero cobra membresía solo al cocinero
    </p>
  </div>
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:12px">
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Explora el mapa</strong><br><span style="font-size:13px;color:var(--text-muted)">Encuentra cocineros cerca de ti</span></div>
          </div>
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Elige tu platillo</strong><br><span style="font-size:13px;color:var(--text-muted)">Agrega al carrito y confirma</span></div>
          </div>
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Paga al cocinero</strong><br><span style="font-size:13px;color:var(--text-muted)">Directo por WhatsApp, transferencia o PayPal/Zelle</span></div>
          </div>
          <div style="margin-top:8px">
            <button class="btn-order" onclick="showPage('map')" style="padding:12px 20px">Buscar Cocineros →</button>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:12px">
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Elige tu plan</strong><br><span style="font-size:13px;color:var(--text-muted)">Gratis 30 días o Pro desde $19/mes</span></div>
          </div>
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Paga tu membresía</strong><br><span style="font-size:13px;color:var(--text-muted)">Con tarjeta, una sola vez al mes</span></div>
          </div>
          <div style="display:flex;gap:12px;align-items:flex-start">
            ...
            <div><strong>Publica y cobra</strong><br><span style="font-size:13px;color:var(--text-muted)">Tus clientes te pagan directo a ti — 0% comisión</span></div>
          </div>
          <div style="margin-top:8px">
            <button onclick="showPage('pago-membresia')" style="width:100%;background:#4CAF50;color:white;border:none;border-radius:10px;padding:12px 20px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;cursor:pointer">Activar membresía →</button>
          </div>
        </div>
      </div>
  ...
  <div class="section">
    <div class="section-title">¿Cómo funciona Micasero?</div>
    <div class="section-sub">Simple, rápido y delicioso.</div>
    <div class="how-grid">
      <div class="how-card">
        <div class="how-icon">🗺️</div>
        <h3>Encuentra tu Cocinero</h3>
        <p>Usa nuestro mapa interactivo para localizar chefs y ver sus menús directamente en tu área.</p>
      </div>
      <div class="how-card">
        <div class="how-icon">🛒</div>
        <h3>Elige tu Platillo</h3>
        <p>Navega los menús, lee reseñas y agrega tus favoritos al carrito con un solo clic.</p>
      </div>
      <div class="how-card">
        <div class="how-icon">🏠</div>
        <h3>Recibe o Recoge</h3>
        <p>Escoge delivery, recoge en casa del cocinero, o ¡vive una cena privada en su hogar!</p>
      </div>
      <div class="how-card">
        <div class="how-icon">⭐</div>
        <h3>Apoya lo Local</h3>
        <p>Cada pedido ayuda a emprendedores culinarios a crecer y compartir su pasión.</p>
      </div>
    </div>
  </div>
  ...
  <div class="section">
    <div class="section-title">Cocineros Destacados</div>
    <div class="section-sub">Los favoritos de tu comunidad esta semana.</div>
...
<div id="page-map" class="page">
  <div class="map-container">
    ...
    <div class="map-filters">
      <button class="filter-btn active" onclick="filterMapLeaflet(this,'todos')">Todos</button>
      ...
      <button class="filter-btn" onclick="filterMapLeaflet(this,'cena')">🕯️ Cena en casa</button>
...
<div id="page-profile" class="page">
  ...
  <div class="profile-body">
    <!-- Banner pago directo -->
    <div style="background:linear-gradient(135deg,#FFF8F0,#FEE8D4);border:1.5px solid #F4C9A8;border-radius:16px;padding:16px 20px;margin-bottom:24px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap">
      <div style="display:flex;gap:12px;align-items:center">
        <span style="font-size:28px">🤝</span>
        <div>
          <div style="font-weight:700;font-size:15px;color:var(--brown)">Pagas directo al cocinero</div>
          <div style="font-size:13px;color:var(--text-muted)">WhatsApp · Transferencia · PayPal / Zelle · Venmo</div>
        </div>
      </div>
      <button class="btn-order" style="padding:10px 20px;white-space:nowrap" onclick="goToCheckout()">Ir al pago →</button>
    </div>
    <div class="profile-grid">
      <div>
        ...
        <h3 class="section-title" style="margin-bottom:16px">Mi Menú</h3>
  ...
  <div class="auth-wrapper">
    <div class="auth-card">
      <div class="auth-logo">
        ...
        <div class="auth-subtitle">¡Únete a la comunidad!</div>
      </div>
      <h2>Crear Cuenta</h2>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="role-select">
          <div class="role-btn selected" onclick="selectRole(this,'cliente')">🍽️ Cliente</div>
          <div class="role-btn" onclick="selectRole(this,'cocinero')">👨‍🍳 Cocinero</div>
        </div>
      </div>
      <div class="form-group">
        <label style="display:flex;gap:10px;align-items:flex-start;cursor:pointer;font-size:13px;color:var(--text-muted)">
          <input type="checkbox" id="accept-terms" style="margin-top:2px;flex-shrink:0;accent-color:var(--orange)">
          <span>Acepto los <a onclick="showPage('terminos')" style="color:var(--orange);cursor:pointer;font-weight:600">Términos de Servicio</a> y la <a onclick="showPage('privacidad')" style="color:var(--orange);cursor:pointer;font-weight:600">Política de Privacidad</a> de Micasero</span>
        </label>
      </div>
      <button class="btn-submit" onclick="showToast('🎉 Cuenta creada exitosamente')">Crear Cuenta</button>
      <div class="divider"><div class="divider-line"></div><span class="divider-text">o regístrate con</span><div class="divider-line"></div></div>
      <button class="social-btn">🌐 Continuar con Google</button>
...
<div id="page-checkout" class="page">
  <div class="checkout-container" style="max-width:700px">
    ...
    <div style="display:flex;align-items:center;gap:0;margin-bottom:32px">
      ...
      <div class="co-step-line"></div>
      <div class="co-step" id="step-ind-3"><span>3</span> Pago</div>
      <div class="co-step-line"></div>
      <div class="co-step" id="step-ind-4"><span>4</span> Listo</div>
    </div>
    ...
    <div id="co-step-1">
      ...
      <button class="btn-pay" onclick="coStep(2)">Continuar → Elegir Entrega</button>
    </div>
    ...
    <div id="co-step-2" style="display:none">
      ...
      <div id="cena-note" style="display:none;background:#F5EFF9;border:1px solid #C39BD3;border-radius:12px;padding:14px 16px;margin-top:-8px;margin-bottom:12px;font-size:13px;color:#6C3483;line-height:1.6">
        🕯️ <strong>Cena privada:</strong> El cocinero te contactará para confirmar fecha, hora, número de personas y precio. Esta opción requiere reserva con al menos 24 horas de anticipación.
      </div>
        <div class="form-group">
      ...
      <div style="display:flex;gap:12px">
        <button class="btn-secondary" style="flex:1;padding:14px;border-radius:12px;cursor:pointer;background:var(--warm);border:1px solid var(--border);font-family:'DM Sans',sans-serif;font-weight:600" onclick="coStep(1)">← Atrás</button>
        <button class="btn-pay" style="flex:2" onclick="coStep(3)">Continuar → Forma de Pago</button>
      </div>
    </div>

    <!-- PASO 3: Método de pago DIRECTO AL COCINERO -->
    <div id="co-step-3" style="display:none">
      <div class="checkout-title">💸 Págale directamente al cocinero</div>
      <p style="color:var(--text-muted);font-size:14px;margin:8px 0 20px">Micasero no procesa este pago. Elige cómo prefieres pagar y el cocinero te enviará los detalles al confirmar.</p>

      <div class="payment-method-card selected" id="pm-whatsapp" onclick="selectPayMethod('whatsapp')">
        <div class="pm-icon">💬</div>
        <div class="pm-info">
          <div class="pm-name">Coordinar por WhatsApp</div>
          <div class="pm-desc">El cocinero te escribe para acordar pago y entrega</div>
        </div>
        <div class="pm-check selected" id="check-whatsapp">✓</div>
      </div>

      <div class="payment-method-card" id="pm-transfer" onclick="selectPayMethod('transfer')">
        <div class="pm-icon">🏦</div>
        <div class="pm-info">
          <div class="pm-name">Transferencia Bancaria</div>
          <div class="pm-desc">El cocinero te comparte su CLABE / cuenta al confirmar</div>
        </div>
        <div class="pm-check" id="check-transfer"></div>
      </div>
      <!-- Datos que aparecen al elegir transferencia -->
      <div id="transfer-info" style="display:none;background:var(--warm);border-radius:12px;padding:16px;margin-top:-4px;margin-bottom:10px;font-size:13px;color:var(--brown-mid)">
        📋 Los datos bancarios del cocinero llegarán a tu correo registrado al confirmar el pedido.
      </div>

      <div class="payment-method-card" id="pm-digital" onclick="selectPayMethod('digital')">
        <div class="pm-icon">📲</div>
        <div class="pm-info">
          <div class="pm-name">PayPal / Venmo / Zelle</div>
          <div class="pm-desc">El cocinero te comparte su usuario al confirmar</div>
        </div>
        <div class="pm-check" id="check-digital"></div>
      </div>
      <!-- Datos que aparecen al elegir digital -->
      <div id="digital-info" style="display:none;background:var(--warm);border-radius:12px;padding:16px;margin-top:-4px;margin-bottom:10px;font-size:13px;color:var(--brown-mid)">
        📧 El cocinero te enviará su usuario de PayPal/Venmo/Zelle por mensaje al confirmar.
      </div>

      <!-- Resumen final antes de confirmar -->
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:16px;margin:20px 0;font-size:14px">
        <div style="font-weight:700;color:var(--brown);margin-bottom:10px">Resumen final</div>
        <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span style="color:var(--text-muted)">Pedido a</span><span>Chef María Rodríguez</span></div>
        <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span style="color:var(--text-muted)">Entrega</span><span id="summary-delivery">Delivery</span></div>
        <div style="display:flex;justify-content:space-between;margin-bottom:6px"><span style="color:var(--text-muted)">Forma de pago</span><span id="summary-payment">WhatsApp</span></div>
        <div style="display:flex;justify-content:space-between;padding-top:10px;border-top:1px solid var(--border);font-weight:700;font-size:16px">
          <span>Total a pagar al cocinero</span>
          <span style="color:var(--orange)" id="summary-total">$0.00</span>
        </div>
      </div>

      <div style="display:flex;gap:12px">
        <button class="btn-secondary" style="flex:1;padding:14px;border-radius:12px;cursor:pointer;background:var(--warm);border:1px solid var(--border);font-family:'DM Sans',sans-serif;font-weight:600" onclick="coStep(2)">← Atrás</button>
        <button class="btn-pay" style="flex:2;background:var(--green)" onclick="processPayment()">✅ Confirmar Pedido</button>
      </div>
      <p style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:10px">Micasero no cobra comisión sobre este pedido</p>
    </div>

    <!-- PASO 4: Confirmado -->
    <div id="co-step-4" style="display:none;text-align:center;padding:40px 20px">
      <div style="font-size:64px;margin-bottom:16px">🎉</div>
      <div style="font-family:'Playfair Display',serif;font-size:26px;font-weight:700;color:var(--brown);margin-bottom:8px">¡Pedido Confirmado!</div>
      <p style="color:var(--text-muted);font-size:15px;line-height:1.7;max-width:400px;margin:0 auto 24px">
        El cocinero recibió tu pedido y te contactará pronto para coordinar el pago y la entrega.
      </p>
      <div style="background:var(--warm);border-radius:16px;padding:20px;max-width:360px;margin:0 auto 28px;text-align:left;font-size:14px">
        ...
        <div style="display:flex;gap:10px;margin-bottom:8px;align-items:flex-start"><span>1️⃣</span> El cocinero te contacta por WhatsApp</div>
        <div style="display:flex;gap:10px;margin-bottom:8px;align-items:flex-start"><span>2️⃣</span> Confirman el pago directo entre ustedes</div>
        <div style="display:flex;gap:10px;align-items:flex-start"><span>3️⃣</span> ¡Disfruta tu comida casera!</div>
      </div>
...
<div id="page-membresia" class="page">
  <div style="background:linear-gradient(135deg,var(--brown) 0%,var(--brown-mid) 60%,var(--orange) 100%);padding:60px 24px 50px;text-align:center">
    ...
    <!-- Botón directo al pago -->
    <button onclick="showPage('pago-membresia')" style="background:white;color:var(--orange);border:none;border-radius:14px;padding:16px 36px;font-family:'DM Sans',sans-serif;font-size:16px;font-weight:800;cursor:pointer;box-shadow:0 4px 20px rgba(0,0,0,0.2);transition:all 0.2s">
      💳 Activar membresía Pro — $19/mes
    </button>
    <div style="color:rgba(255,255,255,0.5);font-size:12px;margin-top:10px">o prueba gratis 30 días ↓</div>
  </div>
  ...
  <div style="background:var(--warm);padding:60px 24px">
    <div style="max-width:800px;margin:0 auto;text-align:center">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:24px;margin-top:32px;text-align:left">

        <!-- PLAN GRATIS -->
        <div style="background:var(--card-bg);border:1.5px solid var(--border);border-radius:24px;padding:32px;position:relative">
          <div style="font-size:13px;font-weight:700;color:var(--text-muted);text-transform:uppercase;letter-spacing:1px;margin-bottom:8px">Prueba Gratuita</div>
          <div style="font-family:'Playfair Display',serif;font-size:40px;font-weight:900;color:var(--brown)">$0</div>
          <div style="font-size:13px;color:var(--text-muted);margin-bottom:24px">Por 30 días · Sin tarjeta</div>
          <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:28px;font-size:14px">
            ...
            <div style="display:flex;gap:10px;align-items:center"><span style="color:var(--green);font-size:16px">✓</span> Hasta 5 platillos en tu menú</div>
            ...
            <div style="display:flex;gap:10px;align-items:center;opacity:0.4"><span>✗</span> Estadísticas avanzadas</div>
          </div>
          <button class="btn-order" onclick="showToast('🎉 ¡Prueba gratuita activada! 30 días sin costo.')">Empezar Gratis →</button>
        </div>
        ...
        <div style="background:linear-gradient(160deg,var(--brown) 0%,var(--brown-mid) 100%);border-radius:24px;padding:32px;position:relative;overflow:hidden">
          ...
          <div style="position:absolute;bottom:-20px;right:-20px;width:120px;height:120px;background:rgba(255,255,255,0.04);border-radius:50%"></div>
          ...
          <div style="font-family:'Playfair Display',serif;font-size:40px;font-weight:900;color:white">$19<span style="font-size:18px;font-weight:400;opacity:0.7">/mes</span></div>
          ...
          <div style="display:flex;flex-direction:column;gap:10px;margin-bottom:28px;font-size:14px;color:rgba(255,255,255,0.85)">
            <div style="display:flex;gap:10px;align-items:center"><span style="color:#7EE8A2;font-size:16px">✓</span> Todo lo del plan gratuito</div>
            ...
            <div style="display:flex;gap:10px;align-items:center"><span style="color:#7EE8A2;font-size:16px">✓</span> Estadísticas de visitas y pedidos</div>
          ...
          <button style="width:100%;background:var(--orange);color:white;border:none;border-radius:10px;padding:12px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;cursor:pointer;transition:all 0.2s" onclick="openMembresiaModal()">Suscribirme al Plan Pro →</button>
        </div>

      </div>

      <!-- Nota de transparencia -->
      <div style="margin-top:32px;padding:20px;background:var(--card-bg);border:1px solid var(--border);border-radius:16px;font-size:14px;color:var(--text-muted);line-height:1.7;text-align:left">
        <strong style="color:var(--brown)">💡 ¿Cómo gana Micasero?</strong><br>
        Micasero cobra una membresía mensual al cocinero por aparecer en la plataforma. <strong>No cobramos comisión sobre tus pedidos</strong> — el dinero de tus clientes es tuyo al 100%. El pago entre cliente y cocinero siempre es directo: transferencia, PayPal, Venmo, Zelle o WhatsApp.
      </div>
    </div>
  </div>
</div>
...
<div id="page-pago-membresia" class="page">
  <div style="max-width:480px;margin:0 auto;padding:32px 20px">
    ...
    <div style="text-align:center;margin-bottom:28px">
      ...
      <div style="font-size:14px;color:var(--text-muted);margin-top:6px">$19/mes · Cancela cuando quieras · Sin comisiones</div>
    </div>
    ...
    <div id="pago-form">
      ...
      <div style="background:var(--warm);border-radius:12px;padding:16px;margin-bottom:20px">
        <div style="display:flex;justify-content:space-between;font-size:14px;margin-bottom:6px">
          <span style="color:var(--text-muted)">Plan Pro Mensual</span><span>$19.00</span>
        </div>
        <div style="display:flex;justify-content:space-between;font-size:14px;margin-bottom:10px">
          <span style="color:var(--text-muted)">Próximo cobro</span><span>en 30 días</span>
        </div>
        <div style="display:flex;justify-content:space-between;font-weight:700;font-size:16px;border-top:1px dashed var(--border);padding-top:10px">
          <span>Hoy pagas</span>
          <span style="color:var(--orange)">$19.00</span>
        </div>
      </div>

      <button class="btn-pay" onclick="confirmarMembresia()" style="font-size:16px">
        🔒 Pagar $19.00 y Activar Plan Pro
      </button>
    ...
    <div id="pago-confirmado" style="display:none;text-align:center;padding:20px 0">
      ...
      <div style="background:var(--warm);border-radius:16px;padding:20px;text-align:left;font-size:14px;margin-bottom:24px">
        ...
        <div style="display:flex;justify-content:space-between;margin-bottom:8px"><span style="color:var(--text-muted)">Cobrado hoy</span><strong>$19.00</strong></div>
...
<div id="page-dashboard" class="page">
  <div style="max-width:800px;margin:0 auto;padding:28px 20px">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;margin-bottom:28px">
      <div>
        <div style="font-family:'Playfair Display',serif;font-size:24px;font-weight:700;color:var(--brown)">Mi Menú 👨‍🍳</div>
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-bottom:28px">
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:16px;text-align:center">
        ...
        <div style="font-size:12px;color:var(--text-muted);margin-top:2px">Platillos</div>
      </div>
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:16px;text-align:center">
        <div style="font-family:'Playfair Display',serif;font-size:26px;font-weight:700;color:var(--green)">⭐4.9</div>
        <div style="font-size:12px;color:var(--text-muted);margin-top:2px">Calificación</div>
      </div>
      <div style="background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:16px;text-align:center">
        <div style="font-family:'Playfair Display',serif;font-size:26px;font-weight:700;color:var(--brown)">🟢</div>
        <div style="font-size:12px;color:var(--text-muted);margin-top:2px">En línea</div>
      </div>
    </div>
    ...
    <div style="display:flex;flex-direction:column;gap:28px;font-size:14px;line-height:1.8;color:var(--text)">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:8px">
          ...
          <div style="background:var(--warm);border-radius:10px;padding:14px"><strong>Cuenta eliminada:</strong> Eliminamos tu perfil e información personal en 30 días. Los registros de pago de membresía se conservan hasta 7 años por obligaciones fiscales y contables.</div>
...
<div class="mobile-nav" id="mobile-nav">
  ...
  <button onclick="showPage('profile')" id="mn-profile">
    <span class="mn-icon">👨‍🍳</span><span class="mn-label" data-i18n="nav-profile">Cocineros</span>
  </button>
  <button onclick="showPage('dashboard')" id="mn-dashboard">
    <span class="mn-icon">📋</span><span class="mn-label" data-i18n="nav-dashboard">Mi Menú</span>
  </button>
...
<div id="mobile-more-menu" style="display:none;position:fixed;bottom:70px;left:0;right:0;z-index:99;background:white;border-top:1px solid var(--border);box-shadow:0 -4px 24px rgba(0,0,0,0.12);border-radius:20px 20px 0 0;padding:20px 16px 8px">
  ...
  <div style="border-top:1px solid var(--border);padding-top:14px">
    ...
    <div style="display:flex;gap:8px;flex-wrap:wrap">
      <button onclick="setLang('es');closeMobileMenu()" id="lang-btn-es" style="background:var(--orange);color:white;border:none;border-radius:20px;padding:8px 16px;font-size:13px;font-weight:700;cursor:pointer;-webkit-appearance:none">🇪🇸 Español</button>
      <button onclick="setLang('en');closeMobileMenu()" id="lang-btn-en" style="background:var(--warm);border:1px solid var(--border);border-radius:20px;padding:8px 16px;font-size:13px;font-weight:600;cursor:pointer;-webkit-appearance:none">🇺🇸 English</button>
      <button onclick="setLang('pt');closeMobileMenu()" id="lang-btn-pt" style="background:var(--warm);border:1px solid var(--border);border-radius:20px;padding:8px 16px;font-size:13px;font-weight:600;cursor:pointer;-webkit-appearance:none">🇧🇷 Português</button>
    </div>
  </div>
  ...
  <div style="max-width:700px;margin:0 auto;padding:32px 20px 60px">
    ...
    <div style="display:flex;flex-direction:column;gap:24px;font-size:14px;line-height:1.8;color:var(--text)">
      ...
      <div>
        ...
        <div style="display:flex;flex-direction:column;gap:10px">
          <div style="background:var(--warm);border-radius:10px;padding:14px">
            <strong>Período de prueba gratuito (30 días):</strong> No se cobra nada, no hay reembolso necesario.
          </div>
          <div style="background:var(--warm);border-radius:10px;padding:14px">
...
function updateCartUI() {
  ...
  if (items.length === 0) {
    list.innerHTML = `<div class="empty-cart"><div class="empty-cart-icon">🍽️</div><p>Tu carrito está vacío</p><p style="font-size:13px;margin-top:4px">¡Agrega platillos deliciosos!</p></div>`;
...
function coStep(n) {
  ...
  if (n === 3) {
    document.getElementById('summary-delivery').textContent =
      currentDelivery === 'delivery' ? 'Delivery 🛵' :
      currentDelivery === 'cena'     ? 'Cena privada 🕯️' : 'Recogida 🏠';
    document.getElementById('summary-payment').textContent = {whatsapp:'WhatsApp 💬', transfer:'Transferencia 🏦', digital:'PayPal/Venmo/Zelle 📲'}[currentPayMethod];
    renderCheckout();
  }
  window.scrollTo(0,0);
}

function selectDelivery2(type) {
  currentDelivery = type;
  ['delivery','pickup','cena'].forEach(t => {
    document.getElementById('del-'+t).classList.remove('selected');
    const c = document.getElementById('del-check-'+t);
    if (c) { c.classList.remove('selected'); c.textContent=''; }
  });
  document.getElementById('del-'+type).classList.add('selected');
  const chk = document.getElementById('del-check-'+type);
  if (chk) { chk.classList.add('selected'); chk.textContent='✓'; }
  document.getElementById('del-address-block').style.display = type==='delivery' ? 'block' : 'none';
  // Show cena note
  const cenaNote = document.getElementById('cena-note');
  if (cenaNote) cenaNote.style.display = type==='cena' ? 'block' : 'none';
}

function selectPayMethod(method) {
  currentPayMethod = method;
  ['transfer','digital','whatsapp'].forEach(m => {
    document.getElementById('pm-'+m).classList.remove('selected');
    const c = document.getElementById('check-'+m);
    c.classList.remove('selected'); c.textContent='';
  });
  document.getElementById('pm-'+method).classList.add('selected');
  const chk = document.getElementById('check-'+method);
  chk.classList.add('selected'); chk.textContent='✓';
  document.getElementById('transfer-info').style.display = method==='transfer' ? 'block' : 'none';
  document.getElementById('digital-info').style.display = method==='digital' ? 'block' : 'none';
}
...
function showPage(name) {
  ...
  window.scrollTo(0, 0);
  if (name === 'checkout') { renderCheckout(); coStep(1); }
...
function renderDashboard() {
  ...
  document.getElementById('dash-count').textContent = cookMenu.length;
...
function toggleAvailable() {
  ...
  const knob   = document.getElementById('avail-knob');
  toggle.style.background = cookAvailable ? 'var(--green)' : '#ccc';
  knob.style.right = cookAvailable ? '3px' : '27px';
  showToast(cookAvailable ? '🟢 Estás disponible en el mapa' : '⛔ Te ocultaste del mapa');
}
...
const translations = {
  es: {
    ...
    'home-subtitle': 'Elige cómo quieres usar la plataforma',
    'client-title': 'Soy Cliente',
    'client-desc': 'Quiero encontrar cocineros y pedir comida casera',
    'client-btn': 'Buscar Cocineros →',
    'cook-title': 'Soy Cocinero',
    'cook-desc': 'Quiero publicar mi menú y conseguir clientes',
    'cook-btn': 'Ver Planes →',
    'map-title': 'Mapa de Cocineros Cercanos',
    'map-desc': 'Cocineros reales en tu área. Haz clic en un pin para ver su perfil y pedir.',
    'locate-btn': '📍 Mostrar mi ubicación',
    'nav-home': 'Inicio',
    'nav-map': 'Mapa',
    'nav-profile': 'Cocineros',
    'nav-dashboard': 'Mi Menú',
    'nav-more': 'Más',
    'note': '💡 Clientes pagan directo al cocinero · Micasero cobra membresía solo al cocinero',
  },
  en: {
    'home-title': 'Welcome to',
    'home-subtitle': 'Choose how you want to use the platform',
    'client-title': 'I\'m a Client',
    'client-desc': 'I want to find home cooks and order food',
    'client-btn': 'Find Cooks →',
    'cook-title': 'I\'m a Cook',
    'cook-desc': 'I want to publish my menu and get clients',
    'cook-btn': 'See Plans →',
    ...
    'nav-map': 'Map',
    'nav-profile': 'Cooks',
    'nav-dashboard': 'My Menu',
    'nav-more': 'More',
    'note': '💡 Clients pay the cook directly · Micasero only charges cooks a membership fee',
  },
  pt: {
    'home-title': 'Bem-vindo ao',
    'home-subtitle': 'Escolha como deseja usar a plataforma',
    'client-title': 'Sou Cliente',
    'client-desc': 'Quero encontrar cozinheiros e pedir comida caseira',
    'client-btn': 'Buscar Cozinheiros →',
    'cook-title': 'Sou Cozinheiro',
    'cook-desc': 'Quero publicar meu menu e conseguir clientes',
    'cook-btn': 'Ver Planos →',
    ...
    'nav-home': 'Início',
    'nav-map': 'Mapa',
    'nav-profile': 'Cozinheiros',
    'nav-dashboard': 'Meu Menu',
    'nav-more': 'Mais',
...
function setLang(lang) {
  ...
  ['es','en','pt'].forEach(l => {
    ...
    if (!btn) return;
    btn.style.background = l === lang ? 'var(--orange)' : 'var(--warm)';
    btn.style.color = l === lang ? 'white' : 'var(--text)';
    btn.style.border = l === lang ? 'none' : '1px solid var(--border)';
  });

  // Update desktop lang button
  const desktopLang = document.getElementById('desktop-lang-btn');
  if (desktopLang) desktopLang.textContent = lang==='es'?'🇪🇸 ES':lang==='en'?'🇺🇸 EN':'🇧🇷 PT';

  // Apply translations to home page
  const map = {
    'Bienvenido a':      {'en':'Welcome to',       'pt':'Bem-vindo ao'},
    'Elige cómo quieres usar la plataforma': {'en':'Choose how you want to use the platform','pt':'Escolha como deseja usar a plataforma'},
    '¿Qué eres tú?':    {'en':'Who are you?',      'pt':'Quem é você?'},
    'Soy Cliente':       {'en':'I\'m a Client',     'pt':'Sou Cliente'},
    'Quiero encontrar cocineros y pedir comida casera': {'en':'I want to find home cooks and order food','pt':'Quero encontrar cozinheiros e pedir comida caseira'},
    'Buscar Cocineros →':{'en':'Find Cooks →',      'pt':'Buscar Cozinheiros →'},
    'Soy Cocinero':      {'en':'I\'m a Cook',       'pt':'Sou Cozinheiro'},
    'Quiero publicar mi menú y conseguir clientes': {'en':'I want to publish my menu and get clients','pt':'Quero publicar meu menu e conseguir clientes'},
    'Ver Planes →':      {'en':'See Plans →',       'pt':'Ver Planos →'},
    'Mapa de Cocineros Cercanos': {'en':'Nearby Cooks Map','pt':'Mapa de Cozinheiros Próximos'},
    'Cocineros reales en tu área. Haz clic en un pin para ver su perfil y pedir.': {'en':'Real cooks in your area. Tap a pin to see their profile and order.','pt':'Cozinheiros reais na sua área. Toque em um pin para ver o perfil e pedir.'},
    '📍 Mostrar mi ubicación': {'en':'📍 Show my location','pt':'📍 Mostrar minha localização'},
    'Inicio':            {'en':'Home',              'pt':'Início'},
    'Mapa':              {'en':'Map',               'pt':'Mapa'},
    'Reseñas':           {'en':'Reviews',           'pt':'Avaliações'},
    'Cocineros':         {'en':'Cooks',             'pt':'Cozinheiros'},
    'Iniciar Sesión':    {'en':'Log In',            'pt':'Entrar'},
    'Regístrate':        {'en':'Sign Up',           'pt':'Cadastre-se'},
    'Mi Menú':           {'en':'My Menu',           'pt':'Meu Menu'},
    'Más':               {'en':'More',              'pt':'Mais'},
    '💡 Clientes pagan directo al cocinero · Micasero cobra membresía solo al cocinero': {
      'en':'💡 Clients pay the cook directly · Micasero only charges cooks a membership fee',
      'pt':'💡 Clientes pagam direto ao cozinheiro · Micasero cobra apenas a adesão do cozinheiro'
    },
  };
  ...
  function translateNode(node) {
    if (node.nodeType === 3) { // text node
      ...
      if (map[trimmed] && map[trimmed][lang]) {
        node.textContent = node.textContent.replace(trimmed, map[trimmed][lang]);
      } else if (lang === 'es') {
        // restore Spanish — find reverse
        Object.entries(map).forEach(([es, others]) => {
          if (others[currentLang === 'es' ? 'en' : 'pt'] === trimmed) {
            node.textContent = node.textContent.replace(trimmed, es);
          }
        });
      }
  ...
  // Translate visible page only for performance
  const activePage = document.querySelector('.page.active');
  if (activePage) translateNode(activePage);

  // Always translate nav + mobile nav
  document.querySelector('nav') && translateNode(document.querySelector('nav'));
  document.getElementById('mobile-nav') && translateNode(document.getElementById('mobile-nav'));
  document.getElementById('mobile-more-menu') && translateNode(document.getElementById('mobile-more-menu'));

  showToast(lang==='es'?'🇪🇸 Español activado':lang==='en'?'🇺🇸 English activated':'🇧🇷 Português ativado');
}
